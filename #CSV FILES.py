...
def register():
    ...
    Label(root1,text="",bg="#733f11").pack()
    ...
    Label(root1,text="",bg="#733f11").pack()
    p_entry=Entry(root1,textvariable=password,width="15",borderwidth=3,show='*')
    p_entry.pack()
    Label(root1,text="",bg="#733f11").pack()
...
def login():
    ...
    root2.configure(bg="#733f11")
    root2.title("Login")
    Label(root2,text="Username",bg="#F9E79F",font=("Georgia",17)).pack()
    Label(root2,text="",bg="#733f11").pack()
    u_entry1=Entry(root2,textvariable=username_verify,width=15,borderwidth=3)
    u_entry1.pack()
    Label(root2,text="",bg="#733f11").pack()
    Label(root2,text="Password",bg="#F9E79F",font=("Georgia",17)).pack()
    Label(root2,text="",bg="#733f11").pack()
    p_entry1=Entry(root2,textvariable=password_verify,width=15,borderwidth=3,show='*')
    p_entry1.pack()
    Label(root2,text="",bg="#733f11").pack()
    button1=Button(root2,text="Login",width=10,command=lambda:login_verify(),bg="#F9E79F",font=("Georgia",13)).pack()
    root2.mainloop()
...
def mainscreen():
    ...
    root.configure(bg="#2e1907")
    heading=Label(root,text="Register/Login Form for AGE CALCULATOR",font=("Georgia",18),bg="#fae5d3").pack()
    Label(root,text="",bg="#2e1907").pack()
    login_button=Button(root,text="Login",width="300",font=("Georgia",15),bg="#fae5d3",command=lambda:login()).pack()
    Label(root,text="",bg="#2e1907").pack()
    register_button=Button(root,text="Register",width="300",font=("Georgia",15),bg="#fae5d3",command=lambda:register()).pack()
    Label(root,text="",bg="#2e1907").pack()
    root.mainloop()
mainscreen()
